...
module.exports = {
    siteUrl:
        process.env.NODE_ENV === `production`
            ? process.env.SITE_URL || config.siteUrl || `https://neon-crepe-895594.netlify.app`
            : `https://neon-crepe-895594.netlify.app`, // Site domain. Do not include a trailing slash!
